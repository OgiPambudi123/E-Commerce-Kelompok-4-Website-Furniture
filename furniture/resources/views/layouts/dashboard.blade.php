...
<head>
  ...
  <link href="{{ asset('back/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('back/assets/css/soft-ui-dashboard.css?v=1.0.7') }}" rel="stylesheet" />
</head>
...
@include('layouts.menudashboard')
 ...
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
  ...
  <script src="{{ asset('back/assets/js/soft-ui-dashboard.min.js?v=1.0.7') }}"></script>
</body>
