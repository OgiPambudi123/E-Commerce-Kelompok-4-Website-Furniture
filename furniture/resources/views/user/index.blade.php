      ...
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          <div class="text-center">
            <img src="{{ asset('back/assets/img/ogi.jpg') }}" alt="profil" class="profile-user-img img-responsive img-circle">
          </div>
          <h3 class="profile-username text-center">Ogi Pambudi</h3>
          <p class="text-muted text-center">Member since : 08 Januari 2023</p>
          <hr>
          <strong>
          ...
          <p class="text-muted">
            201210024@student.mercubuana-yogya.ac.id
          </p>
          <hr>
          <strong>
